...
var pathUtil = require('jsdoc/path')
var conf = env.conf.staticFiles || {}
var filter = new (require('jsdoc/src/filter')).Filter(conf)
var scanner = new (require('jsdoc/src/scanner')).Scanner()
var outDir = env.opts.destination
// `recursive` will be false by default
var recursive = conf.recursive || false
// By default recursion will go three levels deep if `recursive` is `true`
var recursiveLevel = conf.recursiveLevel || (!recursive ? 1 : 3)
